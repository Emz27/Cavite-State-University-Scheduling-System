...
<div id="content" class="col-lg-10 col-sm-10">
    ...
    <div>
        <ul class="breadcrumb">
            ...
            <li>
                <a href="schedroom.php">Room Schedule</a>
            </li>
        </ul>
    </div>
    ...
    <label>School Year</label>
        <select class="form-control" onchange="getRoom()" id = "year" required>
        <?php 
    ...
    <div class="col-md-4">
        <label>
            Term
                ...
                <select class="form-control" onchange="getRoom()" id = "term" required>
        <?php 
...
<br/>
<label>Room:</label>
    <select class="form-control" id = "lect" onchange="getRoom()">
