<?php
	...
	include("header.php");
    $id=$_GET['id'];
    $row=mysql_fetch_array(mysql_query("SELECT * FROM `year` WHERE  YEAR_ID='$id'"));
...
<div id="content" class="col-lg-10 col-sm-10">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-edit"></i> <?php echo $row['YEAR'];?></h2>
...
<?php
    if(isset($_POST['update'])){
            ...
            $results=mysql_query("UPDATE `year` SET `YEAR`='$year' WHERE `YEAR_ID`='$id'");
            if($results){
                echo "<script>
