...
<script type="text/javascript">
    function getProf(){
        var e = document.getElementById("lect");
        var lect = e.options[e.selectedIndex].value;
...
<div id="content" class="col-lg-10 col-sm-10">
    ...
    <div>
        <ul class="breadcrumb">
            ...
            <li>
                <a href="schedprof.php">Schedule of Lecturer</a>
            </li>
        </ul>
    </div>
            ...
            <div class="box-inner">
                ...
                <div class="box-content">
                    <div class="col-md-4">
                        ...
                        <select class="form-control" onchange="getProf()" id = "year" required>
                        <?php 
                    ...
                    <div class="col-md-4">
                        <label>
                            Term
                                ...
                                <select class="form-control" onchange="getProf()" id = "term" required>
                        <?php 
                    ...
                    <div class="col-md-4" style="margin-top:2.5%;">
                        <a class="btn btn-primary" href="#" title="">Lecturer</a>        
                        <a class="btn btn-primary" href="schedclass.php" title="">Sections</a>    
                        <a class="btn btn-primary" href="schedroom.php" title="">Rooms</a>
                        <br/>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-control" id = "lect" onchange="getProf()">
                        <option hidden disabled selected></option>
                        <?php
                            $prof = mysql_query("SELECT * FROM lecturer");
                            while ($lecturer = mysql_fetch_array($prof)){
                                ?>
                                <option value="<?php echo $lecturer['LECTURER_ID'];?>"><?php echo $lecturer['LASTNAME'].", ".$lecturer['FIRSTNAME'];?></option>
                                <?php
                            }
                        ?>      
                        </select>
